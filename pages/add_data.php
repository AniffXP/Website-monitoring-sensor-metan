...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO tbdatasensor (id, waktu, nilaiakurasi) VALUES ('$id', '$waktu', '$nilaiakurasi')";
...
<head>
    ...
    <title>Tambah Data Sensor - Sensor Monitoring System</title>
        ...
        <div class="form-container">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tambah Data Akurasi Sensor</h3>
                </div>
                <div class="card-body">
                    <?php if (isset($error)): ?>
                    ...
                    <form method="POST" action="add_data.php">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" id="id" name="id" placeholder="Masukkan ID sensor" required>
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label" for="waktu">Waktu</label>
                            <input type="datetime-local" class="form-input" id="waktu" name="waktu" required>
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label" for="nilaiakurasi">Nilai Akurasi (ppm)</label>
                            <input type="number" step="0.01" class="form-input" id="nilaiakurasi" name="nilaiakurasi" placeholder="Contoh: 85.5" required>
                        </div>
